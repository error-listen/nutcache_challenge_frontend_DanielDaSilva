...
function MODAL_UPDATE_EMPLOYEE(props) {
    return (
        <div className="modal_create_and_update_employee" ref={props.modal_ref}>
            <div className="modal_content">
                ...
                <div className="buttons">
                    ...
                    <button className="update_employee_button ripple" onClick={props.handle_update_employee}>Update</button>
                </div>
            </div>
        </div>
    )
...
export default MODAL_UPDATE_EMPLOYEE;